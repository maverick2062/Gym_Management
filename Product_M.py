...
def menu(sql_pass):
                            ...
                            try:
                                ...
                                match cho:
                                    ...
                                    case 2:
                                        ...
                                        print("\n\t\t\t --------------------------------- ")
                                        choi=int(input("\n\t\tEnter your choice: "))
                                        L_prod_qty(choi,sql_pass)
                                    case 3:
                                        Catwise_Prod(sql_pass)
                                    case _:
    ...
    ##        case 2:
        ...
        ch = input("\nDo you wish to visit the Inventory menu (Y/N)? ")
        if ch.lower() == 'n':
            con.close()
            print("\n\t\tExiting...")
